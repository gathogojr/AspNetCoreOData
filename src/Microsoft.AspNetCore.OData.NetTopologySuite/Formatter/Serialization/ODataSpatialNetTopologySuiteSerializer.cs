...
internal class ODataSpatialNetTopologySuiteSerializer : ODataSpatialSerializer
{
    ...
    /// </summary>
    public ODataSpatialNetTopologySuiteSerializer()
        : base()
    {
    }
        ...
        ODataSerializerContext writeContext)
    {
        ...
        switch (primitiveType.PrimitiveKind())
        {
            case EdmPrimitiveTypeKind.GeometryPoint:
                {
                    ...
                    spatialValue = ConvertToGeometryPoint(point);
                }
            ...
            case EdmPrimitiveTypeKind.GeographyPoint:
                {
                    Point point = (Point)value;
                    spatialValue = ConvertToGeographyPoint(point);
                }
            ...
            case EdmPrimitiveTypeKind.GeometryLineString:
                {
                    ...
                    spatialValue = ConvertToGeometryLineString(lineString);
                }
            ...
            case EdmPrimitiveTypeKind.GeographyLineString:
                {
                    LineString lineString = (LineString)value;
                    spatialValue = ConvertToGeographyLineString(lineString);
                }

                break;
            default:
                // If the value is not a recognized spatial type, throw an exception.
                throw Error.InvalidOperation(SRResources.CannotWriteType, typeof(ODataSpatialNetTopologySuiteSerializer), value.GetType().FullName);
        ...
        //        // TODO: Handle other spatial types - LineString, Polygon, MultiPoint, MultiLineString, MultiPolygon, GeometryCollection, etc.
