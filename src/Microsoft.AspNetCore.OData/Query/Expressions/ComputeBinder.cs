...
{
    /// <summary>
    /// The default implementation to bind an OData $apply represented by a <see cref="ComputeTransformationNode"/> to an <see cref="Expression"/>.
    /// </summary>
    public class ComputeBinder : QueryBinder, IComputeBinder
    {
        ...
        public Expression BindCompute(ComputeTransformationNode computeTransformationNode, QueryBinderContext context)
        {
            ...
            wrapperTypeMemberAssignments.Add(Expression.Bind(wrapperContainerProperty, AggregationPropertyContainer.CreateNextNamedPropertyContainer(properties)));
