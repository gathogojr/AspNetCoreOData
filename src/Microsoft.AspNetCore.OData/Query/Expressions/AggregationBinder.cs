...
namespace Microsoft.AspNetCore.OData.Query.Expressions
{
    ...
    public class AggregationBinder : QueryBinder, IAggregationBinder
    {
            ...
            out IDictionary<SingleValueNode, Expression> flattenedPropertiesMap)
        {
            ...
            for (int i = 0; i < aggregateExpressions.Count; i++)
            {
                ...
                UnaryExpression flattenedAccessExpression = Expression.Convert(
                    Expression.Property(containerExpression, QueryConstants.AggregationPropertyContainerValueProperty),
                    type);
            ...
            PropertyInfo wrapperProperty = typeof(AggregationWrapper).GetProperty(QueryConstants.GroupByWrapperGroupByContainerProperty);
        ...
        /// </summary>
        /// <param name="groupingParameter">The </param>
        /// <param name="aggregateExpression">The aggregate expression.</param>
