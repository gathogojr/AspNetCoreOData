...
public class FilterBinderTests
{
    ...
    public void CustomMethod_InstanceMethodOfDeclaringType()
    {
        ...
        try
        {
            ...
            // Act & Assert
            GetModel<DataTypes>().AddCustomUriFunction(padrightMethodName, padrightStringEdmFunction);
        ...
        {
            Assert.True(GetModel<DataTypes>().RemoveCustomUriFunction(padrightMethodName));
    ...
    public void CustomMethod_AddSignatureAndBindFunctionWithShortcut()
    {
        ...
        try
        {
            ...
            // Add the custom function
            // Act & Assert
            GetModel<DataTypes>().AddCustomUriFunction(padrightMethodName, padrightStringEdmFunction, padRightStringMethodInfo);
